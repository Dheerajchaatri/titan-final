    ...
    <div className="flex flex-col gap-6 text-left w-full">
      <div>
        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary-navy/5 text-xs font-bold text-primary-navy border border-primary-navy/10 self-start">
          <Sparkles className="h-3.5 w-3.5 text-primary-navy" />
          <span>Candidate AI Assistant</span>
        </span>
        <h3 className="text-xl font-black text-primary-navy mt-2">AI Career Assistant</h3>
        <p className="text-xs font-semibold text-text-muted mt-1">
          Plan your career milestones, analyze tech skills gap indicators, and chat with your personalized AI advisor.
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start w-full">
        {/* Left Column: Chat Workspace */}
        <div className="lg:col-span-7 bg-white border border-border-color rounded-2xl shadow-sm flex flex-col h-[500px] overflow-hidden">
          ...
          <form onSubmit={handleSend} className="p-4 bg-white border-t border-border-color flex items-center gap-3">
            <input
              ...
              className="flex-grow px-4 py-3 bg-slate-50 border border-border-color rounded-xl text-xs focus:outline-none focus:border-primary-navy focus:bg-white transition-all placeholder:text-text-muted text-text-primary font-medium"
            />
            <button
              type="submit"
        ...
        {/* Right Column: Career Roadmap & Skills Gap */}
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="bg-white border border-border-color rounded-2xl p-5 shadow-sm flex flex-col gap-4">
            <h3 className="text-xs font-black uppercase tracking-wider text-primary-navy border-b border-slate-50 pb-2 flex items-center gap-1.5">
              <Target className="h-4.5 w-4.5 text-primary-navy" />
                ...
                <div key={i} className="flex gap-4 items-start relative">
                  <div className="flex flex-col items-center flex-shrink-0">
                    <span className={cn(
                      ...
                      step.status === "completed" && "bg-primary-navy/10 border-primary-navy text-primary-navy",
